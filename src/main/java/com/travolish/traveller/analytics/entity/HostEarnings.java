...
@Table(name = "host_earnings", indexes = {
    ...
    @Index(name = "idx_earnings_booking_id", columnList = "booking_id"),
    @Index(name = "idx_earnings_date", columnList = "earned_date"),
    @Index(name = "idx_earnings_status", columnList = "status")
})
@Data
@NoArgsConstructor
@AllArgsConstructor
